...
class CreateChain extends React.Component {
  ...
  state = {
    openDetails: false,
    openExpiredDate: false,
    openArrivalDate: false,
  };
  ...
  toggleExpiredDate = () => {
    this.setState((prevState) => ({
      openExpiredDate: !prevState.openExpiredDate,
    }));
  };

  toggleArrivalDate = () => {
    this.setState((prevState) => ({
      openArrivalDate: !prevState.openArrivalDate,
    }));
  };
    ...
    return (
      <Layout>
        ...
        >
          ...
          >
            ...
            <Form.Field>
              ...
              <Input
                ...
                onChange={(event) =>
                  this.setState({
                    ProductImageInforrmation: event.target.value,
                  })
                }
              />
            </Form.Field>
            ...
            <br />
            <h4 style={{ color: "blue" }}> Made By: </h4>
            <Form.Field>
            ...
            <Form.Field>
              ...
              <Input
                ...
                onChange={(event) =>
                  this.setState({
                    madeByCompanyInformation: event.target.value,
                  })
                }
              />
            </Form.Field>
            ...
            <br />
            <h4 style={{ color: "blue" }}> Made With: </h4>
            ...
            <Form.Field>
              <Input
                value={this.state.madeWith}
                onChange={(event) =>
                  this.setState({ madeWith: event.target.value })
                }
              />
            </Form.Field>
          </Expand>
          ...
          <Button onClick={this.toggleExpiredDate}>
            <h3>Enter Product Expired Date</h3>
          </Button>
          <Expand
            open={this.state.openExpiredDate}
            duration={1000}
            transitions={transitions}
          >
            <br />
          ...
          <Button onClick={this.toggleArrivalDate}>
            <h3>Enter Product Arrival Date</h3>
          </Button>
          <Expand
            open={this.state.openArrivalDate}
            duration={1000}
            transitions={transitions}
          >
            <br />
          ...
          />
          <Button loading={this.state.loading} primary onClick={this.onSubmit}>
            {" "}
            Create{" "}
          </Button>
        </Form>
